...
export default function PortalSelect() {
  return (
    <div className="min-h-screen w-full flex bg-paper">
      {/* Left hero panel — unchanged from the original design. Switched to md: instead of
          lg: so it shows up reliably on more screen widths instead of disappearing on
          medium windows, which is what made the page look empty before. */}
      <div className="hidden md:flex md:w-1/2 text-ink flex-col justify-between p-12 relative overflow-hidden bg-[linear-gradient(150deg,#CDEAE4_0%,#EAF4F1_35%,#FAFCFB_70%,#FFFFFF_100%)] border-r-[3px] border-teal">
        ...
        <div className="flex items-center gap-2.5 relative">
          ...
          <p className="font-semibold text-lg tracking-tight text-ink">
            BIC SmartCare
          </p>
        </div>
        ...
        <div className="relative max-w-md">
          ...
          <p className="text-slate text-[14.5px] mt-4 leading-relaxed">
            Patient records, appointments, and billing in one place — with EMI
            plans built in for bills patients can't pay all at once. Admins,
            doctors, and patients each sign in to their own view.
          </p>
      ...
      {/* Right panel — Option A: logo, "Welcome", and the three portal cards. */}
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-sm">
          <div className="flex flex-col items-center text-center mb-8">
            <div className="flex items-center gap-2.5 mb-6 md:hidden">
              <div className="w-9 h-9 rounded-xl bg-[linear-gradient(150deg,#0C443E_0%,#1B7A72_60%,#2FA096_100%)] flex items-center justify-center">
                <Cross size={16} strokeWidth={2.5} className="text-white" />
              </div>
              <span className="font-semibold text-[16px] tracking-tight text-ink">
                BIC SmartCare
              </span>
            </div>
